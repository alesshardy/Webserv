...
/**
 * @brief Construit la réponse HTTP en fonction de la requête.
 * 
 * @return int 
 */
...
/*************************************************Methodes de gestion des requêtes**************************************************/
...
/**
 * @brief  Envoie une réponse HTTP chunked au client.
 * 
 * @param filePath 
 * @param contentType 
 */
...
/**
 * @brief  Vérifie si l'URI correspond à une redirection dans un bloc location ou server.
 * 
 * @return true 
 * @return false 
 */
...
/**
 * @brief  Extrait le chemin du fichier à partir de la requête HTTP.
 * 
 * @param request 
 * @return std::string 
 */
...
/**
 * @brief  Résout le chemin du fichier demandé en fonction de l'URI.
 * 
 * @return std::string 
 */
...
/**
 * @brief  Récupère le type de contenu d'un fichier en fonction de son extension.
 * 
 * @param filePath 
 * @return std::string 
 */
...
/**
 * @brief  Résout le chemin du fichier demandé en fonction de l'URI et de la configuration du serveur.
 *  
 * @return std::string 
 */
